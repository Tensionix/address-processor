...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "ru": {
        ...
        "logs": "Журнал",
        "release": "Релиз",
        "open_input": "Открыть исходники",
        "open_output": "Открыть результаты",
        "open_logs": "Открыть журнал",
        "open_release": "Открыть релизы",
        "operations": "Операции",
        ...
        "confirm_maintenance_note": "Действие может изменить управляемую рабочую папку. Исходные файлы удалять нельзя.",
        "cancel": "Отмена",
