...
title Audion Address Processor - Builder
...
cls
echo ======================================================================
echo   AUDION ADDRESS ALIGNER - BUILDER
echo ======================================================================
echo Root: %BASE_DIR%
echo.
...
type "%MENU_FILE%" | "%FZF_EXE%" --prompt="audion@address-processor [BUILDER] > " --pointer=">" --header="Pick step:" --layout=reverse --border="rounded" --info=hidden --margin=1,2 > "%RES_FILE%"
