...
title Audion Address Processor - Build Portable Env
...
echo ======================================================================
echo   AUDION ADDRESS ALIGNER - BUILD PORTABLE ENV
echo ======================================================================
echo Root:       %ROOT%
...
"%RUNTIME_DIR%\python.exe" -m pip download --disable-pip-version-check --timeout 120 --retries 12 setuptools wheel packaging -d "%WHEELHOUSE_DIR%"
...
"%RUNTIME_DIR%\python.exe" -m pip download --disable-pip-version-check --no-build-isolation --timeout 120 --retries 12 -r "%REQ_FILE%" -d "%WHEELHOUSE_DIR%"
if errorlevel 1 goto ERR_WHEELS
