...
title Audion Address Processor - Make Release Archive
...
robocopy "%ROOT%" "%STAGE_PROJECT%" /E /R:1 /W:1 /NFL /NDL /NJH /NJS /NP /XD "%ROOT%\.git" "%ROOT%\release" "%ROOT%\.venv" "%ROOT%\venv" "%ROOT%\__pycache__" /XF "%ROOT%\api_key.txt" "%ROOT%\api_key_openai.txt" >nul
set "RC=%errorlevel%"
...
:BANNER
echo ======================================================================
echo   AUDION ADDRESS ALIGNER - MAKE RELEASE ARCHIVE
echo ======================================================================
echo Root:    %ROOT%
